...
<style>
:root{--bg:#f4f6f9;--panel:#fff;--ink:#18202b;--muted:#667085;--line:#dfe4eb;--blue:#2563eb;--orange:#d97706;--teal:#0f766e;--violet:#7c3aed}
...
main{max-width:1180px;margin:auto;padding:30px 22px 60px}h1{font-size:27px;margin:0 0 4px}h2{font-size:18px;margin:0 0 4px}p{margin:0}.intro,.note,.meta{color:var(--muted)}.intro{font-size:15px;margin-bottom:22px}
.grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.panel{background:var(--panel);border:1px solid var(--line);border-radius:12px;padding:18px;margin-bottom:16px;box-shadow:0 2px 8px #18202b0a}.wide{grid-column:1/-1}
.controls{display:flex;gap:8px;flex-wrap:wrap;margin:13px 0 10px}select,input{border:1px solid #cfd6df;border-radius:7px;background:#fff;color:var(--ink);padding:7px 9px;font:inherit}input{min-width:240px}
...
.tooltip{position:fixed;display:none;pointer-events:none;background:#111827;color:#fff;border-radius:7px;padding:7px 9px;font-size:12px;line-height:1.4;box-shadow:0 5px 18px #0004;z-index:9;max-width:300px}
...
@media(max-width:760px){.grid{grid-template-columns:1fr}.panel{padding:14px}main{padding:20px 12px}.wide{grid-column:auto}}
</style><main>
